...
def get_admin_main_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="Gift / Discount Codes", callback_data="admin:codes")],
            [InlineKeyboardButton(text="Broadcast", callback_data="admin:broadcast")],
            [InlineKeyboardButton(text="Pricing / Config", callback_data="admin:pricing")],
...
def get_back_to_admin_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[[InlineKeyboardButton(text="Back to Admin", callback_data="admin:main")]]
    )
...
def get_admin_users_kb(users: list[User], page: int, total_pages: int, search: str | None = None) -> InlineKeyboardMarkup:
    ...
    for user in users:
        ...
        label = (
            ...
            f"N:{user.normal_credits} V:{user.vip_credits} | {vip_status} | {ban_status}"
        )
        builder.row(
    ...
    if page > 1:
        nav_row.append(
            InlineKeyboardButton(text="Prev", callback_data=f"admin:users:page:{page - 1}:search:{search_token}")
        )
    nav_row.append(InlineKeyboardButton(text=f"{page}/{total_pages}", callback_data="admin:noop"))
    if page < total_pages:
        nav_row.append(
            InlineKeyboardButton(text="Next", callback_data=f"admin:users:page:{page + 1}:search:{search_token}")
        )
    builder.row(*nav_row)
    builder.row(InlineKeyboardButton(text="Search User", callback_data="admin:users:search"))
...
def get_user_manage_kb(user: User, page: int = 1, search: str | None = None) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Add Normal Credits", callback_data=f"admin:user:add_normal:{user.telegram_id}")],
            [InlineKeyboardButton(text="Add VIP Credits", callback_data=f"admin:user:add_vip:{user.telegram_id}")],
...
def get_code_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="List Active Codes", callback_data="admin:codes:list")],
            [InlineKeyboardButton(text="Back", callback_data="admin:main")],
        ]
    )
...
def get_code_kind_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="Gift VIP Access Days", callback_data="admin:codes:kind:gift_vip_days")],
            [InlineKeyboardButton(text="Discount Code", callback_data="admin:codes:kind:discount_percent")],
            [InlineKeyboardButton(text="Back", callback_data="admin:codes")],
        ]
    )
...
def get_code_generation_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="Manual Code Input", callback_data="admin:codes:generate:manual")],
            [InlineKeyboardButton(text="Back", callback_data="admin:codes")],
        ]
    )
...
def get_codes_list_kb(codes: list[PromoCode]) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="Back", callback_data="admin:codes"))
    return builder.as_markup()
...
def get_code_detail_kb(code_id: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Disable Code", callback_data=f"admin:codes:disable:{code_id}")],
            [InlineKeyboardButton(text="Inspect Usage", callback_data=f"admin:codes:usage:{code_id}")],
            [InlineKeyboardButton(text="Back", callback_data="admin:codes:list")],
        ]
    )
