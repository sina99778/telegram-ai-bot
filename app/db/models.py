...
from sqlalchemy import BigInteger, String, Float, Boolean, Text, CheckConstraint, Index, Enum as SQLEnum, ForeignKey
...
class User(Base):
    ...
    subscription_expires_at: Mapped[Optional[datetime]] = mapped_column(timezone=True)
...
class PaymentTransaction(Base):
    ...
    provider_payment_id: Mapped[Optional[str]] = mapped_column(String(255), unique=True, index=True)
